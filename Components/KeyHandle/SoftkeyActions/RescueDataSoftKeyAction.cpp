...
//    KeyActionDesc("", "SoftkeyArrow.png", RescueDataSoftKeyAction::exit),
    ...
    KeyActionDesc("", trs("Delete"), "Delete.png",  RescueDataSoftKeyAction::clearData),
    KeyActionDesc("", trs("EventReview"), "Summary.png", RescueDataSoftKeyAction::eventReview),
    KeyActionDesc("", trs("OxyCRGEventReview"), "Summary.png", RescueDataSoftKeyAction::oxyCRGEventReview),
