...
enum KeyTypeMask
{
    KEY_PAT_INFO_MASK = 1 << (SOFT_BASE_KEY_PAT_INFO - SOFT_BASE_KEY_PAT_INFO),
    KEY_PAT_NEW_MASK = 1 << (SOFT_BASE_KEY_PAT_NEW - SOFT_BASE_KEY_PAT_INFO),
    KEY_ECG_LEAD_MODE_MASK = 1 << (SOFT_BASE_KEY_ECG_LEAD_MODE - SOFT_BASE_KEY_PAT_INFO),
    KEY_ALARM_LIMIT_MASK = 1 << (SOFT_BASE_KEY_ALARM_LIMIT - SOFT_BASE_KEY_PAT_INFO),
    KEY_CODE_MARKER_MASK = 1 << (SOFT_BASE_KEY_CODE_MARKER - SOFT_BASE_KEY_PAT_INFO),
    KEY_TREND_GRAPH_MASK = 1 << (SOFT_BASE_KEY_TREND_GRAPH - SOFT_BASE_KEY_PAT_INFO),
    KEY_EVENT_REVIEW_MASK = 1 << (SOFT_BASE_KEY_EVENT_REVIEW - SOFT_BASE_KEY_PAT_INFO),
    KEY_SYS_MODE_MASK = 1 << (SOFT_BASE_KEY_SYS_MODE - SOFT_BASE_KEY_PAT_INFO),
    KEY_WINDOWLAYOUT_MASK = 1 << (SOFT_BASE_KEY_WINDOWLAYOUT - SOFT_BASE_KEY_PAT_INFO),
#ifndef HIDE_PARAM_SWITCH
    KEY_PARA_SWITCH_MASK = 1 << (SOFT_BASE_KEY_PARA_SWITCH - SOFT_BASE_KEY_PAT_INFO),
#endif
    KEY_SCREEN_BAN_MASK = 1 << (SOFT_BASE_KEY_SCREEN_BAN - SOFT_BASE_KEY_PAT_INFO),
#ifndef HIDE_STANDBY_FUNCTION
    KEY_STANDBY_MASK = 1 << (SOFT_BASE_KEY_STANDBY - SOFT_BASE_KEY_PAT_INFO),
#endif
    KEY_CO2_CALIBRATION_MASK = 1 << (SOFT_BASE_KEY_CO2_CALIBRATION - SOFT_BASE_KEY_PAT_INFO),
    KEY_CO2_HANDLE_MASK = 1 << (SOFT_BASE_KEY_CO2_HANDLE - SOFT_BASE_KEY_PAT_INFO),
    KEY_IBP_CALIBRATION_MASK = 1 << (SOFT_BASE_KEY_IBP_CALIBRATION - SOFT_BASE_KEY_PAT_INFO),
    KEY_CALCULATION_MASK = 1 << (SOFT_BASE_KEY_CALCULATION - SOFT_BASE_KEY_PAT_INFO),
    KEY_KEYBOARD_VOLUMN_MASK = 1 << (SOFT_BASE_KEY_KEYBOARD_VOLUMN - SOFT_BASE_KEY_PAT_INFO),
    KEY_SCREEN_BRIGHTNESS_MASK = 1 << (SOFT_BASE_KEY_SCREEN_BRIGHTNESS - SOFT_BASE_KEY_PAT_INFO),
    KEY_NIGHT_MODE_MASK = 1 << (SOFT_BASE_KEY_NIGHT_MODE - SOFT_BASE_KEY_PAT_INFO),
    KEY_PRINTER_SET_MASK = 1 << (SOFT_BASE_KEY_PRINTER_SET - SOFT_BASE_KEY_PAT_INFO),
    KEY_NR_MASK = 1 << (SOFT_BASE_KEY_NR - SOFT_BASE_KEY_PAT_INFO)
};
