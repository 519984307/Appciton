...
PowerMangerBrief * PowerMangerBrief::_selfObj = NULL;
...
void PowerMangerBrief::powerOff()
{
...
PowerMangerBrief::PowerMangerBrief()
    : QObject(),
      d_ptr(new PowerMangerBriefPrivate(this))
{
}

void PowerMangerBriefPrivate::monitorRun()
{
...
void PowerMangerBriefPrivate::initBatteryData()
{
    lowBattery = false;
    shutBattery = false;
}

BatteryPowerLevel PowerMangerBriefPrivate::getCurrentVolume()
{
...
void PowerMangerBriefPrivate::updateBatAlarm(BatOneShotType type, bool isOccure)
{
    batteryOneShotAlarm.setOneShotAlarm(type, isOccure);
}

bool PowerMangerBriefPrivate::hasBattery()
{
...
void PowerMangerBriefPrivate::shutdownWarn()
{
    // 清除界面弹出框
