...
public:
    ...
    BatteryIconStatus getStatus(void) {return batteryBarWidget.getStatus();}

    // 是否处于defib禁用
    bool isdefibDisable(void) const {return _defibDisable;}
...
private:
    ...
    //电源线插拔时作出行为
    void _powerLineChange(const PowerSuplyType &lastPowerType,const PowerSuplyType &currentPowerType, const bool &powerTypeChange);
