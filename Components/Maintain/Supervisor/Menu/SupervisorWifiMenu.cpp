...
{
public:
    Q_DECLARE_PUBLIC(SupervisorWifiMenu)

    SupervisorWifiMenuPrivate(SupervisorWifiMenu * const q_ptr)
    ...
    SupervisorWifiMenu * const q_ptr;
 ...
 **************************************************************************************************/
void SupervisorWifiMenuPrivate::onProfileItemClick()
{
 ...
 **************************************************************************************************/
void SupervisorWifiMenuPrivate::updateProfileList()
{
    //remove old item
 ...
 **************************************************************************************************/
void SupervisorWifiMenuPrivate::onListExit(bool backTab)
{
    Q_Q(SupervisorWifiMenu);
    if(backTab)
    {
 ...
 **************************************************************************************************/
bool caseInsensitiveLessThan(const WiFiProfileInfo &p1, const WiFiProfileInfo &p2)
{
 ...
 **************************************************************************************************/
void SupervisorWifiMenuPrivate::onBtnClick()
{
    Q_Q(SupervisorWifiMenu);
 ...
 **************************************************************************************************/
void SupervisorWifiMenuPrivate::loadProfiles()
{
    QString tmpStr;
    int tmpValue=0;
    int count;
 ...
 **************************************************************************************************/
void SupervisorWifiMenuPrivate::saveProfiles()
{
    bool ok;
    QString tmpStr;
    if(!currentConfig.getStrAttr("WiFi|Profiles", "Count", tmpStr))
 ...
 **************************************************************************************************/
SupervisorWifiMenu &SupervisorWifiMenu::construction()
{
    static SupervisorWifiMenu *_instance = NULL;
    if(_instance == NULL)
    {
        _instance =  new SupervisorWifiMenu;
    }
    return *_instance;
}
 ...
 **************************************************************************************************/
void SupervisorWifiMenu::focusFirstItem()
{
 ...
 **************************************************************************************************/
bool SupervisorWifiMenu::eventFilter(QObject *obj, QEvent *ev)
{
 ...
 **************************************************************************************************/
void SupervisorWifiMenu::layoutExec()
{
    Q_D(SupervisorWifiMenu);
 ...
 **************************************************************************************************/
void SupervisorWifiMenu::readyShow()
{
    Q_D(SupervisorWifiMenu);
 ...
 * constructor
 **************************************************************************************************/
SupervisorWifiMenu::SupervisorWifiMenu()
    :SubMenu(trs("WiFiMenu")),d_ptr(new SupervisorWifiMenuPrivate(this))
{
...
#include "moc_SupervisorWifiMenu.cpp"
