...
public:
    ...
    static const char *convert(IBPOneShotType index)
    {
        static const char *symbol[IBP_ONESHOT_NR] =
        {
            ...
            "IBP1ZeroCalibSuccess", "IBP2ZeroCalibSuccess",
            "IBP1MeasurePressureIsPulse", "IBP2MeasurePressureIsPulse",
            "IBP1ZeroCalibPressureBeyondMeasureRange",
            "IBP2ZeroCalibPressureBeyondMeasureRange",
            "IBP1LeadOffZeroCalibFail", "IBP2LeadOffZeroCalibFail",
            "IBP1NoSetZeroCalibTime", "IBP2NoSetZeroCalibTime",

            "IBP1CalibrationSuccess", "IBP2CalibrationSuccess",
            "IBP1MeasurePressureIsPulse", "IBP2MeasurePressureIsPulse",
            "IBP1CalibrationPressureBeyondMeasureRange",
            "IBP2CalibrationPressureBeyondMeasureRange",
            "IBP1NoZeroCalib", "IBP2NoZeroCalib",
            "IBP1LeadOffCalibrationFail", "IBP2LeadOffCalibrationFail",
            "IBP1NoSetCalibrationTime", "IBP2NoSetCalibrationTime",
