...
enum SPO2OneShotType
{
    ...
    SPO2_2_ONESHOT_ALARM_CHECK_SENSOR,
    SPO2_2_ONESHOT_ALARM_CABLE_OFF,
    SPO2_2_ONESHOT_ALARM_FINGER_OFF,
    SPO2_2_ONESHOT_ALARM_LED_FAULT,
    SPO2_2_ONESHOT_ALARM_COMMUNICATION_STOP,
    SPO2_2_ONESHOT_ALARM_SIGNAL_WEAK,
    SPO2_2_ONESHOT_ALARM_SIGNAL_SATURATION,
    SPO2_2_ONESHOT_ALARM_LOW_PERFUSION,
    SPO2_2_ONESHOT_ALARM_DEFECTIVE_CABLE,
    SPO2_2_ONESHOT_ALARM_CABLE_EXPIRED,
    SPO2_2_ONESHOT_ALARM_INCOMPATIBLE_CABLE,
    SPO2_2_ONESHOT_ALARM_UNRECONGNIZED_CABLE,
    SPO2_2_ONESHOT_ALARM_CABLE_NEAR_EXPIRATION,
    SPO2_2_ONESHOT_ALARM_SENSOR_EXPIRED,
    SPO2_2_ONESHOT_ALARM_INCOMPATIBLE_SENSOR,
    SPO2_2_ONESHOT_ALARM_UNRECONGNIZED_SENSOR,
    SPO2_2_ONESHOT_ALARM_DEFECTIVE_SENSOR,
    SPO2_2_ONESHOT_ALARM_CHECK_CABLE_AND_SENSOR_FAULT,
    SPO2_2_ONESHOT_ALARM_SENSOR_NEAR_EXPIRATION,
    SPO2_2_ONESHOT_ALARM_NO_ADHESIVE_SENSOR,
    SPO2_2_ONESHOT_ALARM_ADHESIVE_SENSOR_EXPIRATION,
    SPO2_2_ONESHOT_ALARM_INCOMPATIBLE_ADHESIVE_SENSOR,
    SPO2_2_ONESHOT_ALARM_UNRECONGNIZED_ADHESIVE_SENSOR,
    SPO2_2_ONESHOT_ALARM_DEFECTIVE_ADHESIVE_SENSOR,
    SPO2_2_ONESHOT_ALARM_SENSOR_INITING,
    SPO2_2_ONESHOT_ALARM_INTERFERENCE_DETECTED,
    SPO2_2_ONESHOT_ALARM_DEMO_MODE,
    SPO2_2_ONESHOT_ALARM_ADHESIVE_SENSOR_NEAR_EXPIRATION,
    SPO2_2_ONESHOT_ALARM_CHECK_SENSOR_CONNECTION,
    SPO2_2_ONESHOT_ALARM_SPO2_ONLY_MODE,
    SPO2_2_ONESHOT_ALARM_BOARD_FAILURE,
...
enum SPO2LimitAlarmType
{
    ...
    SPO2_LIMIT_ALARM_PI_LOW,
    SPO2_LIMIT_ALARM_PI_HIGH,
