...
enum NIBPOneShotType
{
    ...
    NIBP_ONESHOT_ALARM_SELTTEST_ERROR,           // 模块自检失败
    NIBP_ONESHOT_ALARM_MODULE_ABNORMAL,          // 模块异常
    NIBP_ONESHOT_ALARM_MODULE_NOT_CALIBRATE,      // 模块未校准
    NIBP_ONESHOT_ALARM_MODULE_ERROR,             // 模块错误
    NIBP_ONESHOT_ALARM_MODULE_OVER_PRESSURE_PROTECT,  // 模块过压保护
    NIBP_ONESHOT_NR,
};
