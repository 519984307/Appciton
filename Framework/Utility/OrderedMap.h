 ...
 **
 ** Written by Bingyun Chen <chenbingyun@blmed.cn>, 2018/9/14
 **/


/*
 * OrderedMap store keys according to their insertion order, so if you add a key that already
 * exists, it's order is changed to being the last key in the Map. Eg:
...
public:
    ...
    public:
        ...
        const_iterator(const iterator &i) :         // NOLINT
