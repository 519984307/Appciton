...
bool SmtpClient::connectToHost()
{
    ...
    if(isSendCancel || (!networkManager.isWifiWorking()) || (!networkManager.isWiFiConnected()))
    {
...
bool SmtpClient::isSendMessCancel()
{
    return isSendCancel;
}
...
//        }
        ...
        do {
            ...
            if(isSendCancel || (0 >= times) ||
                    (!networkManager.isWifiWorking()) || (!networkManager.isWiFiConnected()))
            {
                emit smtpError(ResponseTimeoutError);
                throw ResponseTimeoutException();
            }
...
void SmtpClient::sendMailCancelProcess()
{
    isSendCancel = true;
}
