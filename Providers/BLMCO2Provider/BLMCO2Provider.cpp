...
void BLMCO2Provider::setApneaTimeout(ApneaAlarmTime t)
{
    ...
    switch(t)
    {
    case APNEA_ALARM_TIME_20_SEC: cmd[3] = 20; break;
    case APNEA_ALARM_TIME_25_SEC: cmd[3] = 25; break;
    case APNEA_ALARM_TIME_30_SEC: cmd[3] = 30; break;
    case APNEA_ALARM_TIME_35_SEC: cmd[3] = 35; break;
    case APNEA_ALARM_TIME_40_SEC: cmd[3] = 40; break;
    case APNEA_ALARM_TIME_45_SEC: cmd[3] = 45; break;
    case APNEA_ALARM_TIME_50_SEC: cmd[3] = 50; break;
    case APNEA_ALARM_TIME_55_SEC: cmd[3] = 55; break;
    case APNEA_ALARM_TIME_60_SEC: cmd[3] = 60; break;
    default: break;
    }
 ...
 * 构造。
 *************************************************************************************************/
BLMCO2Provider::BLMCO2Provider() : Provider("BLM_CO2"), CO2ProviderIFace()
{
