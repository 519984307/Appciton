...
enum TT3PacketType
{
    ...
    TT3_CMD_GET_VERSION                          = 0x10,       // 获取版本信息。
    TT3_RSP_GET_VERSION                          = 0x11,       //

    TT3_CMD_SET_PROBE                            = 0x12,       // 设置探头类型。
    TT3_RSP_SET_PROBE                            = 0x13,       //
    TT3_CMD_SELF_STATE                           = 0x14,       // 获取自检状态。
    TT3_RSP_SELF_STATE                           = 0x15,       //
    TT3_CMD_PROBE_STATE                          = 0x16,       // 获取测量状态。
    TT3_RSP_PROBE_STATE                          = 0x17,       //
    TT3_CMD_CHANNEL                              = 0x18,       // 体温定标。
    TT3_RSP_CHANNEL                              = 0x19,       //

    TT3_NOTIFY_START_UP                          = 0x40,       // 启动帧。
    TT3_NOTIFY_DATA                              = 0x41,       // 测量数据
    TT3_NOTIFY_OVERRANGE                         = 0x42,       // 测量超界帧
    TT3_NOTIFY_PROBE_OFF                         = 0x43,       // 探头脱落帧

    TT3_CYCLE_ALIVE                              = 0x5B,       // 保活帧
    TT3_CYCLE_DATA                               = 0x5C,       // 原始数据

    TT3_DATA_ERROR                               = 0x76,       // 错误警告帧

    TT3_UPGRADE_ALIVE                            = 0xFE,       //升级保活帧
};

class TT3Provider: public BLMProvider, public TEMPProviderIFace
{
public: // Provider的接口。
